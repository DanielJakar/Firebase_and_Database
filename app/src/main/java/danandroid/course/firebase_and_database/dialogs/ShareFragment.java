package danandroid.course.firebase_and_database.dialogs;
...
import danandroid.course.firebase_and_database.R;
...
public class ShareFragment extends BottomSheetDialogFragment {
    ...
    public static class UserAdapter extends FirebaseRecyclerAdapter<User, UserAdapter.UserViewHolder>{
        ...
        public UserAdapter(Query query, ShoppingLists shoppingLists, Fragment fragment) {
        ...
        protected void populateViewHolder(UserViewHolder viewHolder, User model, int position) {
            ...
            viewHolder.shoppingLIsts = shoppingLIsts;
        }
        ...
        public static class UserViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public void onClick(final View v) {
                //get the model -> save it under uid selected user
                //save them to the db under uid of the selected usr:
